...
skip_re='(^|/)(\._|Uu?[Nn][Ii][Nn][Ss][Tt][Aa][Ll][Ll]|[Cc]rash[Hh]andler|[Cc]rash[Rr]eport|[Cc]rash[Uu]ploader|UnityCrashHandler|[Cc]rs-|EAAntiCheat|EALaunchHelper|[Ss]etup|[Cc]onfig|[Bb]enchmark|RGL|[Ll]auncher|[Pp]rerequisite|vc_redist)'
